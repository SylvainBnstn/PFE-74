...
###############################################################################
    ...
    def demand(self, p_t, p_t_1, d_0=250, k=1, a=1, b=3):
        d = self.plus(d_0 - k*p_t - a*self.shock(self.plus(p_t - p_t_1)) + b*self.shock(self.minus(p_t - p_t_1))) 
